...
function Main({
  ...
  const data: ChartData = useMemo(() => {
    ...
    const background = ctx?.createLinearGradient(0, 0, 0, 100);
    background?.addColorStop(0, props.backgroundColor);
    background?.addColorStop(1, darkMode ? "#28344e00" : "#ffffff01");

    const secondaryBackground = ctx?.createLinearGradient(0, 0, 0, 100);
    secondaryBackground?.addColorStop(0, getColor("slate.50"));
    secondaryBackground?.addColorStop(
      1,
      darkMode ? "#28344e00" : "#ffffff01",
    );
  ...
  }, [darkMode, props.backgroundColor, props.borderColor, props.index]);
