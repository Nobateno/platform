    ...
    <>
      ...
      >
        <HeadlessDialog.Panel
          as={as}
          className={twMerge([
            "w-[90%] mx-auto bg-m3-surface text-m3-on-surface relative rounded-m3-xl shadow-m3-3 transition-transform",
...
Dialog.Title = ({
  ...
  return (
    <HeadlessDialog.Title
      as={as}
      className={twMerge([
        "m3-title-large flex items-center px-5 py-3 border-b border-m3-outline-variant",
        className,
      ])}
      {...props}
    >
...
Dialog.Footer = <C extends React.ElementType = "div">({
  ...
  return (
    <Component
      className={twMerge([
        "px-5 py-3 text-end border-t border-m3-outline-variant",
        className,
      ])}
      {...props}
    >
